...
////            layoutParams.width =  Math.round(getHorizontalSpace() / Math.ceil(getItemCount() / getSpanCount()));
//            layoutParams.width =  Math.round(getHorizontalSpace() / getSpanCount());
//        }
//        else if(getOrientation() == VERTICAL){
////            layoutParams.height =  Math.round(getVerticalSpace() / Math.ceil(getItemCount() / getSpanCount()));
//            layoutParams.height =  Math.round(getVerticalSpace() / getSpanCount());
//        }
        layoutParams.height =  Math.round(getHorizontalSpace() / getSpanCount());
        return layoutParams;
    }
